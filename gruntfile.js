...
module.exports = function (grunt) {
  ...
  grunt.registerTask('wtest', ['connect', 'webdriver'])
  grunt.registerTask('wtestc', ['connect', 'webdriver:chrome'])
  grunt.registerTask('wtestf', ['connect', 'webdriver:firefox'])
  grunt.registerTask('wtesti', ['connect', 'webdriver:ie'])
